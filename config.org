...
(use-package exec-path-from-shell
  ...
  (progn (exec-path-from-shell-initialize)
         ...
         (setenv "SHELL" (expand-file-name "/usr/local/bin/zsh"))))
...
Use [[https://github.com/rranelli/auto-package-update.el][auto-package-update]] to update installed packages every 10 day and to remove old packages:
...
(use-package paradox
  :ensure t
  :disabled t ;; it doesn't work yet with Emacs 25.3
  :init
  :config
...
#+end_src
** Ethereum' Solidity Mode

Emacs' solidity-mode: https://github.com/ethereum/emacs-solidity

#+BEGIN_SRC emacs-lisp
;; PATH to solidity checkers' binaries
(setq solidity-solc-path "/usr/local/bin/solc")
(setq solidity-solium-path "/Users/AW/.antigen-nvm/versions/node/v9.1.0/bin/solium")

;; Activate solc and solium checkers to work together with Flycheck
(setq solidity-flycheck-solc-checker-active t)
(setq solidity-flycheck-solium-checker-active t)

;; PATH to solium RC file
(setq flycheck-solidity-solium-soliumrcfile "/Users/AW/Dev/Solidity/.soliumrc.json")

(use-package solidity-mode
  :ensure t
  :config
  ;; Choose the commenting style
  ;; with double slash //
